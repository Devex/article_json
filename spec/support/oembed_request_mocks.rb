module OembedRequestStubs
  def stub_oembed_requests(additional_headers = {}, custom_body: nil, error: false)
    stub_oembed_facebook_request(
      additional_headers,
      custom_body: custom_body,
      error: error
    )
    stub_oembed_vimeo_request(
      additional_headers,
      custom_body: custom_body,
      error: error
    )
    stub_oembed_youtube_request(
      additional_headers,
      custom_body: custom_body,
      error: error
    )
    stub_oembed_slideshare_request(
      additional_headers,
      custom_body: custom_body,
      error: error
    )
    stub_oembed_tweet_request(
      additional_headers,
      custom_body: custom_body,
      error: error
    )
    stub_oembed_soundcloud_request(
      additional_headers,
      custom_body: custom_body,
      error: error
    )
  ...
  def stub_oembed_facebook_request(
    additional_headers = {},
    custom_body: nil,
    error: false
  )
  ...
  def stub_oembed_youtube_request(
    additional_headers = {},
    custom_body: nil,
    error: false
  )
  ...
  def stub_oembed_slideshare_request(
    additional_headers = {},
    custom_body: nil,
    error: false
  )
  ...
  def stub_oembed_soundcloud_request(
    additional_headers = {},
    custom_body: nil,
    error: false
  )
